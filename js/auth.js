...
function fillProfile(){
  ...
  $('lineStatus').textContent = currentUser.lineUserId
    ? `เชื่อมแล้ว: ${currentUser.lineDisplayName || currentUser.lineUserId}`
...
function loginWithLine(){
  ...
  location.href = REQUEST_ACT_CONFIG.API_URL + '?action=lineLogin&returnTo=' + encodeURIComponent(returnTo);
}
